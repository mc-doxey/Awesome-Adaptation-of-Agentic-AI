...
|:-----------:|:-----------:|-----------|:-----------:|:-----------:|:-----------:|
| 2025.02| DeepRetrieval | DeepRetrieval: Hacking Real Search Engines and Retrievers with Large Language Models via Reinforcement Learning | COLM'25 | [paper](https://arxiv.org/pdf/2503.00223) | [code](https://github.com/pat-jj/DeepRetrieval) |
